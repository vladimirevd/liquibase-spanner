CREATE TABLE test_table_base (id INT64, test_column INT NULL, CONSTRAINT PK_TEST_TABLE_BASE PRIMARY KEY (id));
CREATE TABLE test_table_reference (id INT64, test_column INT NULL, CONSTRAINT PK_TEST_TABLE_REFERENCE PRIMARY KEY (id));
